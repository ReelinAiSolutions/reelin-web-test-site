    ...
    <div className="bg-white dark:bg-black min-h-screen text-black dark:text-white pt-32 pb-20 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-6 mb-24">
        <div className="max-w-4xl">
          ...
          <div className="flex gap-4">
             <Button size="lg" to="/contact" className={isFullStack ? "bg-white text-black hover:bg-zinc-200 dark:bg-white dark:text-black" : ""}>
                Deploy System
             </Button>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-16">
        ...
        <div className="lg:col-span-2 space-y-16">
           ...
           {/* Long Description */}
           <section>
              <h3 className="text-sm font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mb-6">The Deep Dive</h3>
              <p className="text-lg md:text-xl leading-relaxed text-zinc-700 dark:text-zinc-300 font-light">
                 {tier.longDescription || tier.description}
              </p>
           </section>
        ...
        <div className="lg:col-span-1">
           <div className={`sticky top-32 p-8 rounded-3xl ${isFullStack ? 'bg-zinc-900 text-white border border-zinc-800' : 'bg-zinc-50 dark:bg-zinc-900/50 border border-zinc-200 dark:border-zinc-800'}`}>
              ...
              <Button to="/contact" className="w-full justify-center" variant={isFullStack ? 'secondary' : 'primary'}>
                Initialize Request
              </Button>
           </div>
        </div>
